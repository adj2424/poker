...
export function RevealPanel({
  ...
  return (
    <div className="w-full max-w-xl rounded-xl border border-paper/10 bg-rail/90 p-5 shadow-2xl backdrop-blur">
      ...
      <dl className="mt-4 grid grid-cols-3 gap-3 border-t border-paper/10 pt-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <dd className="tabular font-display text-lg font-bold text-paper">{pct(verdict.equityVsRandom)}</dd>
        </div>
        <div className="flex flex-col gap-1">
      ...
      <p className="mt-3 font-mono text-[10.5px] leading-relaxed text-paper/35">
      ...
      <button
        type="button"
        onClick={onNext}
        className="mt-4 w-full rounded-lg bg-accent px-4 py-2.5 font-display font-bold text-ink transition-colors hover:bg-accent-dim hover:text-paper focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
      >
